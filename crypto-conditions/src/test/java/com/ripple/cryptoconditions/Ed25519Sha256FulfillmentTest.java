...
public class Ed25519Sha256FulfillmentTest extends AbstractCryptoConditionTest {
  ...
  /**
   * Tests concurrently creating an instance of {@link Ed25519Sha256Fulfillment}. This test validates the fix for Github
  ...
  public final void testValidateWithDifferentConditionType() {
    ...
    final Ed25519Sha256Fulfillment narrowlyTypedActual = constructEd25519Sha256Fulfillment(ed25519KeyPair);
