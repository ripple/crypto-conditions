...
public class TestKeyFactory {
   ...
   *
   * @param base64UrlEncodedModulus A base64Url-encoded String representing the public key bytes for the key to
   *                                assemble.
   *
   ...
   *
   * @param base64UrlEncodedPublicKey A base64Url-encoded String representing the public key bytes for the key to
   *                                  assemble.
   *
   * @return A {@link EdDSAPublicKey}.
   */
