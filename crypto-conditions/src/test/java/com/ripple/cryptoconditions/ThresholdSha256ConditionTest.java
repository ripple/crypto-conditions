...
import static com.ripple.cryptoconditions.helpers.TestFulfillmentFactory.MESSAGE2;
import static com.ripple.cryptoconditions.helpers.TestFulfillmentFactory.PREIMAGE1;
import static com.ripple.cryptoconditions.helpers.TestFulfillmentFactory.PREIMAGE2;
...
public class ThresholdSha256ConditionTest extends AbstractCryptoConditionTest {
  ...
  /**
   * Tests concurrently creating an instance of {@link ThresholdSha256Condition}. This test validates the fix for Github
  ...
  /**
   * Constructs a Threshold Condition using two duplicate conditions, and asserts that only one is used in total.
   */
  @Test
  ...
  /**
   * Constructs a Threshold Condition using two conditions, and asserts that the resulting conditions is valid.
   */
  @Test
  ...
  /**
   * Constructs a Threshold Condition using an immutable list of two conditions, and asserts that the resulting
   * condition is valid.
   */
  @Test
