...
public class RsaSha256FulfillmentCryptoConditionModuleTest extends
  ...
  public static Collection<Object[]> data() {
    ...
    return Arrays.asList(new Object[][]{
        {Encoding.HEX, RSA_FULFILLMENT_DER_BYTES_HEX},
        {Encoding.BASE64, RSA_FULFILLMENT_DER_BYTES_BASE64},
        {Encoding.BASE64_WITHOUT_PADDING, RSA_FULFILLMENT_DER_BYTES_BASE64_WITHOUTPADDING},
        {Encoding.BASE64URL, RSA_FULFILLMENT_DER_BYTES_BASE64_URL},
        {Encoding.BASE64URL_WITHOUT_PADDING, RSA_FULFILLMENT_DER_BYTES_BASE64_URL_WITHOUTPADDING}
    });
  }
